...
Conversation.create!(user_a_id: 3, user_b_id: 2, id: 11)

Message.create!(conversation_id: 11, user_id: 3, content: "Test 1" )
Message.create!(conversation_id: 11, user_id: 2, content: "Test 1" )
Message.create!(conversation_id: 11, user_id: 3, content: "Test 2" )
Message.create!(conversation_id: 11, user_id: 2, content: "Test 2" )
Message.create!(conversation_id: 11, user_id: 3, content: "Test 3" )
Message.create!(conversation_id: 11, user_id: 2, content: "Test 3" )
Message.create!(conversation_id: 11, user_id: 3, content: "Test 4" )
Message.create!(conversation_id: 11, user_id: 2, content: "Test 4" )
